...
const log = Bunyan.createLogger({ name : 'tikva:controller/AdminMOReceiver' });
...
class AdminMOReceiver extends MOReceiver {
    ...
    constructor(params) {
        ...
        actions.sendMessage = (message) => {
            log.info("DID WE GET HERERERERERERERERERER>>>>>>>>>>>>");
...
module.exports = AdminMOReceiver;